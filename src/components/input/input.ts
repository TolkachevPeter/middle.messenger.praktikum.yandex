...
export default class Input extends Block {
	...
	handleFocus() {
        this.getElement().querySelector('.input')!.classList.remove('input_style_invalid');
	}
	...
	handleBlur() {
		...
		if (!this.isInputValid(inputValue)) {
            ...
            this.getElement().querySelector('.input')!.classList.add('input_style_invalid');
            (
                this.getElement().querySelector('.input__error-msg'
                )! as HTMLElement
